...
export default function Header(){
    return (
        <div className="pt-8 px-10 flex justify-between relative">
            <div className="flex items-center">
                ...
                <div className="ml-16 flex items-center space-x-12 text-Medium-Gray font-medium">
                    <button className="flex items-center hover:text-Almost-Black">
            ...
            {/* dropdown 1 */}
            <div className="bg-white p-6 hidden text-Medium-Gray font-medium rounded-xl shadow-lg absolute top-20 left-28">
            ...
            {/* dropdown 2 */}
            <ul className="bg-white hidden list-none font-medium text-Medium-Gray p-6 rounded-xl shadow-lg space-y-2 absolute  top-20 left-80">
                <li>History</li>
                <li>Our Team</li>
                <li>Blog</li>
            </ul>
