    ...
    return (
        <>
            ...
            <div className="flex items-center">
                ...
                {(win > 768) && <div className="lg:ml-16 md:ml-8 flex items-center lg:space-x-12 md:space-x-4 text-Medium-Gray font-medium">
            ...
            {/* dropdown 1 */}
            {(showFeatures && (win > 768)) &&  <div className="bg-white p-6  text-Medium-Gray font-medium rounded-xl shadow-lg absolute top-20 left-28">
            ...
            {/* dropdown 2 */}
            {(showCompany && (win > 768)) && <ul className="bg-white list-none font-medium text-Medium-Gray p-6 rounded-xl shadow-lg space-y-2 absolute  top-20 left-80">
                <li>History</li>
                <li>Our Team</li>
                <li>Blog</li>
            </ul>}
            ...
            {/* menu */}
            {(win <= 768) && <button onClick={showMenuHandler}>
         ...
         {/* modal menu */}
         {showMenu && <div ref={menuRef} className="fixed top-0 left-0 z-10 w-full h-full bg-black bg-opacity-50">
            <div className="bg-white px-5 pt-5 w-2/3 h-full absolute right-0">
                <button onClick={showMenuHandler} className="absolute right-5">
                ...
                <ul className="mt-16 font-medium text-Medium-Gray space-y-4">
                    <li>
                        <button onClick={showFeatureHandler} className="flex items-center hover:text-Almost-Black space-x-4">
                            <p>Features</p>
                            { showFeatures ? 
                            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                            : <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                        ...
                        {showFeatures && <ul className="space-y-2 ml-6 mt-5">
                            <li className="flex items-center space-x-3">
                                <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14 3v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1V1a1 1 0 1 1 2 0v1h2V1a1 1 0 1 1 2 0v1h2V1a1 1 0 0 1 2 0v1h1a1 1 0 0 1 1 1Zm-2 3H2v1h10V6Zm0 3H2v1h10V9Zm0 3H2v1h10v-1Z" fill="#726CEE"/></svg>
                                <p>Todo List</p>
                            </li>
                    ...
                    <li>
                        <button onClick={showCompanyHandler} className="flex hover:text-Almost-Black items-center space-x-4">
                            <p>Company</p>
                            { showCompany ? 
                            <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/></svg>
                            : <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg"><path stroke="#686868" strokeWidth="1.5" fill="none" d="m1 1 4 4 4-4"/></svg>
                        ...
                        {showCompany && <ul className=" ml-6 mt-5 space-y-3">
                            <li>History</li>
                            <li>Our Team</li>
                            <li>Blog</li>
                        </ul>}
                ...
                <div className="grid mt-8 font-medium text-Medium-Gray">
                    ...
                    <button className="mt-3 border-Medium-Gray hover:text-Almost-Black hover:border-Almost-Black border-2 rounded-xl py-2">Register</button>
                </div>
            </div>
        </div>}
        </>
